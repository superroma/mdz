...
const resolveLinkUrl = (href: string, parentPath?: string): { url: string; isExternal: boolean; isMdLink: boolean } => {
...
const createMdxComponents = (
  ...
  Tabs,
  Tab,
  a: (props: React.AnchorHTMLAttributes<HTMLAnchorElement> & { 'data-md-link'?: string; 'data-external'?: string }) => {
